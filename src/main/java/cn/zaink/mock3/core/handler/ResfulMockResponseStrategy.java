...
@Slf4j
@Component
public class ResfulMockResponseStrategy implements MockResponseStrategy {
    private final ResponseService responseService;

    public ResfulMockResponseStrategy(ResponseService responseService) {
